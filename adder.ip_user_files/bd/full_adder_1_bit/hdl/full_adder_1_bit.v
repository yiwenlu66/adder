...
(* CORE_GENERATION_INFO = "full_adder_1_bit,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=full_adder_1_bit,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "full_adder_1_bit.hwdef" *) 
module full_adder_1_bit
  ...
  full_adder_1_bit_xup_xor2_0_0 xup_xor2_0
       (.a(A_1),
        .b(B_1),
        .y(xup_xor2_0_y));
  full_adder_1_bit_xup_xor2_1_0 xup_xor2_1
       (.a(xup_xor2_0_y),
        .b(CI_1),
        .y(xup_xor2_1_y));
endmodule
