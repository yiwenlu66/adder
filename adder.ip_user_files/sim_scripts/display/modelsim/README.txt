...
#
# Generated by export_simulation on Thu Nov 24 14:29:42 +0800 2016
#
################################################################################
...
switch to the './display.sh' script.

./display.sh -reset_run
...
./display.sh -noclean_files

For more information on the script, please type './display.sh -help'.
