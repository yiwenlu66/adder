...
#
# Generated by export_simulation on Thu Nov 24 14:40:05 +0800 2016
#
################################################################################
...
switch to the './calculator.sh' script.

./calculator.sh -reset_run
...
./calculator.sh -noclean_files

For more information on the script, please type './calculator.sh -help'.
