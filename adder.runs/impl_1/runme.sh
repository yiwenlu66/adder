...
HD_PWD='C:/Users/peter/adder/adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log peripheral_test_ver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source peripheral_test_ver.tcl -notrace
