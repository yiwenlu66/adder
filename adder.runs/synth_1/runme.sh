...
HD_PWD='C:/Users/peter/adder/adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log peripheral_test_ver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source peripheral_test_ver.tcl
