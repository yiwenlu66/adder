...
HD_PWD='C:/Users/peter/adder/adder.runs/top_xup_4_to_1_mux_vector_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xup_4_to_1_mux_vector_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_xup_4_to_1_mux_vector_0_0.tcl
