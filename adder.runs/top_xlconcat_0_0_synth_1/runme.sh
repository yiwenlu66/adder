...
HD_PWD='C:/Users/peter/adder/adder.runs/top_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_xlconcat_0_0.tcl
