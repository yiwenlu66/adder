...
HD_PWD='C:/Users/peter/adder/adder.runs/complement_xlconstant_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complement_xlconstant_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source complement_xlconstant_3_0.tcl
