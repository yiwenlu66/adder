...
HD_PWD='C:/Users/peter/adder/adder.runs/display_calculator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_calculator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_calculator_0_0.tcl
