...
HD_PWD='C:/Users/peter/adder/adder.runs/full_adder_1_bit_xup_nand2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_1_bit_xup_nand2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_1_bit_xup_nand2_0_0.tcl
