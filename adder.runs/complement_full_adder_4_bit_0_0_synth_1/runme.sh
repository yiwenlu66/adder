...
HD_PWD='C:/Users/peter/adder/adder.runs/complement_full_adder_4_bit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complement_full_adder_4_bit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source complement_full_adder_4_bit_0_0.tcl
